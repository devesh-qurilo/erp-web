...
//           `/topic/discussion-rooms/${roomId}`,
//           (msg) => {
//             const payload: MessageItem = JSON.parse(msg.body);
...
//   /* ================= SEND REPLY (REAL TIME) ================= */
//   const sendReply = async () => {
//     if (!reply && !file) return;

//     // FILE → REST (same as before)
//     if (file) {
//       const fd = new FormData();
//       if (reply) fd.append("content", reply);
//       fd.append("file", file);
...
//       destination: `/app/discussion-rooms/${roomId}/send`,
//       body: JSON.stringify({
//         content: reply,
//         messageType: "TEXT",
//       }),
...
//                     {m.messageType === "FILE" && m.fileUrl && (
//                       <div className="relative mt-2 border rounded p-2 flex justify-between">
//                         <div className="flex items-center gap-2">
//                           {isImage(m.mimeType) ? (
//                             <img
//                               src={m.fileUrl}
...
//                         {openFileMenuId === m.id && (
//                           <div className="absolute right-2 top-10 bg-white border rounded shadow w-40">
//                             <button
//                               onClick={() => window.open(m.fileUrl!, "_blank")}
//                               className="flex gap-2 px-4 py-2 text-sm w-full"
//                             >
//                               <Eye size={14} /> View
//                             </button>
//                             <button
...
//                     />
//                     {openMenuId === m.id && (
//                       <div className="absolute right-0 bg-white border rounded shadow w-52">
//                         <button
//                           onClick={() => toggleBestReply(m)}
//                           className="flex gap-2 px-4 py-2 text-sm w-full"
//                         >
...
//                         <button
//                           onClick={() => deleteMessage(m.id)}
//                           className="flex gap-2 px-4 py-2 text-sm text-red-600 w-full"
//                         >
...
//         <label className="border-dashed border rounded p-4 flex flex-col items-center cursor-pointer mb-4">
//           <Upload />
//           <span className="text-sm mt-2">
//             {file ? file.name : "Choose a file"}
//           </span>
